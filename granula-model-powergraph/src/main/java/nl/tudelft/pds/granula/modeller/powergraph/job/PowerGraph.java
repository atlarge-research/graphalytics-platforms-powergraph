...
package nl.tudelft.pds.granula.modeller.powergraph.job;
...
import nl.tudelft.pds.granula.modeller.powergraph.operation.*;
import nl.tudelft.pds.granula.modeller.rule.derivation.DerivationRule;
import nl.tudelft.pds.granula.modeller.rule.extraction.PowerGraphExtractionRule;
import nl.tudelft.pds.granula.modeller.rule.filling.UniqueOperationFilling;

/**
 * Created by wing on 12-3-15.
 */
public class PowerGraph extends JobModel {
    ...
    public void loadRules() {
        ...
        addFillingRule(new UniqueOperationFilling(2, PowerGraphType.TopActor, PowerGraphType.TopMission));
...
//            }
            ...
            job.setName("A PowerGraph job");
            job.setType("PowerGraph");
