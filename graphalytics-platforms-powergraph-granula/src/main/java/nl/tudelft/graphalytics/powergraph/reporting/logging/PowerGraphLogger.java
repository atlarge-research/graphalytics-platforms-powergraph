 ...
 */
package nl.tudelft.graphalytics.powergraph.reporting.logging;
 ...
 */
public class PowerGraphLogger {

    protected static final Logger LOG = LogManager.getLogger(PowerGraphLogger.class);
